<template>
  <nav class="navbar navbar-expand-lg">
    <div class="container">
      <router-link to="/" class="navbar-brand">Yookai</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-lg-4">
          ...
          <li class="nav-item">
            <router-link to="/skills" class="nav-link">{{ $t("skills") }}</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/experience" class="nav-link">{{ $t("experience") }}</router-link>
          </li>
          <li class="nav-item">
...
<style scoped>
/* Aquí podrías agregar más estilos si es necesario */
</style>
